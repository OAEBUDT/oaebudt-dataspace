...
public class ReportApiController {
    ...
    public Response createAsset(CreateAssetRequest request) {
        try {
            ...
            createAssetInConnector(request.title(), request.metadata(), request.reportType(),
                    request.accessDefinition(), request.url(), request.method(), request.authHeaderKey(),
                    request.authCode(), request.headers());
    ...
    void createAssetInConnector(String title, Map<String, Object> assetMetadata, ReportType reportType, String accessDefinition, String uri,
    ...
    private void validateCreateAsset(CreateAssetRequest request) {
        ...
        if(Objects.isNull(request.reportType())) {
