...
import static org.oaebudt.edc.report.WebApiExtension.NAME;
...
public class WebApiExtension implements ServiceExtension {
    ...
    @Configuration
    private ParticipantApiConfiguration participantApiConfiguration;
    ...
    public void initialize(final ServiceExtensionContext context) {
        ...
        portMappingRegistry.register(new PortMapping(PARTICIPANT, participantApiConfiguration.port(), participantApiConfiguration.path()));
        ...
        webService.registerResource(PARTICIPANT, new ParticipantGroupApiController(participantGroupStore, policyDefinitionService, monitor));
    ...
    @Settings
    public record ParticipantApiConfiguration(
            @Setting(key = "web.http." + PARTICIPANT + ".port", description = "Port for " + PARTICIPANT + " api context", defaultValue = "no:op")
            int port,
            @Setting(key = "web.http." + PARTICIPANT + ".path", description = "Path for " + PARTICIPANT + " api context", defaultValue = "no:op")
            String path
    ) {}
